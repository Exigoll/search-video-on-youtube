...
import logoSvg from "../../assets/svg/authorization.svg";
  ...
  return (
    <div className={styles.authorization}>
      <div className={styles.authorization__wrapper}>
        <div className={`${styles.authorization__logo} ${styles.logo}`}>
          <img src={logoSvg} width={88} height={88} alt="Logo authorization" />
          <p>Вход</p>
        </div>
        <form className={`${styles.authorization__form} ${styles.form}`}>
          <label>
            Логин
            <input type="text" />
          </label>
